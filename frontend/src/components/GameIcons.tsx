...
export const ICONS = {
  ...
  work: 'M20 6H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V8a2 2 0 00-2-2zM16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2M2 10h20',
  creative: 'M12 19l7-7 3 3-7 7-3-3zM18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5zM2 2l7.586 7.586',
